...
export const metadata: Metadata = { title: titles['terms'] + ' — Grand Masala', alternates: { canonical: '/terms' } };

export default async function Page() {
  const data = await serverFetch<any>('/admin/page/' + slugMap['terms']);
  const page = data?.page;
  return (
    <div className="min-h-screen bg-[#F4F1EA]">
      <div className="bg-[#81190B] text-white py-16 text-center"><h1 className="text-4xl font-bold">{titles['terms']}</h1></div>
