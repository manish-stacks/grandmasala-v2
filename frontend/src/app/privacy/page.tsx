...
export const metadata: Metadata = { title: titles['privacy'] + ' — Grand Masala', alternates: { canonical: '/privacy' } };

export default async function Page() {
  const data = await serverFetch<any>('/admin/page/' + slugMap['privacy']);
  const page = data?.page;
  return (
    <div className="min-h-screen bg-[#F4F1EA]">
      <div className="bg-[#81190B] text-white py-16 text-center"><h1 className="text-4xl font-bold">{titles['privacy']}</h1></div>
