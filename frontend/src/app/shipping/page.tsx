...
export const metadata: Metadata = { title: titles['shipping'] + ' — Grand Masala', alternates: { canonical: '/shipping' } };

export default async function Page() {
  const data = await serverFetch<any>('/admin/page/' + slugMap['shipping']);
  const page = data?.page;
  return (
    <div className="min-h-screen bg-[#F4F1EA]">
      <div className="bg-[#81190B] text-white py-16 text-center"><h1 className="text-4xl font-bold">{titles['shipping']}</h1></div>
